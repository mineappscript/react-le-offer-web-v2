...
const getButton = (buttonType = BUTTON_TYPE_CLASSES.primary) => {
  return {
    [BUTTON_TYPE_CLASSES.primary]:
      ' mobile:h-12 mobile:mb-3 mb-5 text-sm font flex items-center justify-center   text-sm bg-btn-primary-light text-text-primary-light dark:text-text-secondary-dark border-none hover:scale-102 transition-all duration-300 ease-in hover:cursor-pointer w-full outline-none h-11 border rounded text-sm font-semibold ',
